...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 bg-[#f8f9f8] text-[#1a1a1a] font-sans overflow-hidden select-none" role="main" aria-label="E-Magazine Resep Sehat JSR">
      ...
      {/* Magazine Container */}
      <div id="magazine-content" className="relative w-full h-full flex items-center justify-center perspective-[2000px] px-2 sm:px-4 md:px-0 py-16 md:py-0">
        <AnimatePresence initial={false} custom={direction}>
          <motion.div
            ...
            className="relative w-full aspect-[0.7/1] md:aspect-auto md:w-full md:h-full md:max-w-none bg-white md:shadow-none shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] flex overflow-hidden border border-black/5 touch-none pb-20 md:pb-28"
            aria-live="polite"
          >
